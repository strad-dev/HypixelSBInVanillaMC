...
public class Sadan implements CustomMob {
	...
	public String onSpawn(Player p, Mob e) {
		...
		String newName = "<gold><bold>﴾ <red><bold>Sadan<gold><bold> ﴿";
			...
			if(damager instanceof LivingEntity entity && random.nextDouble() < 0.25) {
				switch(random.nextInt(7)) {
					case 0 -> {
						...
						damager.sendMessage(Utils.msg("<red><bold>Sadan has stomped you into the ground!"));
					...
					case 1, 2 -> {
						...
						damager.sendMessage(Utils.msg("<red><bold>Sadan has shot you with Laser Eyes!"));
						damager.getWorld().playSound(damager.getLocation(), Sound.ENTITY_GUARDIAN_DEATH, 1.0F, 2.0F);
					}
					case 3, 4 -> {
						damagee.swingMainHand();
						CustomDamage.customMobs(entity, damagee, 25, DamageType.MELEE);
						damager.sendMessage(Utils.msg("<red><bold>Sadan attacks you violently with his Diamond Sword!"));
