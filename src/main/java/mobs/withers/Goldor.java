...
public class Goldor implements CustomWither {
	...
	public String onSpawn(Player p, Mob e) {
		...
		String newName = "<gold><bold>﴾ <red><bold>Goldor<gold><bold> ﴿";
		wither.getAttribute(Attribute.ARMOR_TOUGHNESS).setBaseValue(13.0);
		wither.addScoreboardTag("Goldor");
		Bukkit.broadcast(Utils.msg("<red><bold>GOLDOR, the most defensive Wither in the universe, has come to stand in your way!"));
